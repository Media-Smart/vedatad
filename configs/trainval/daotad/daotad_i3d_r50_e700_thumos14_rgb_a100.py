...
# 6. checkpoint
weights = dict(
    filepath='workdir/daotad_i3d_r50_e700_thumos14_rgb_a100/epoch_600_optim.pth'), # 'open-mmlab://i3d_r50_256p_32x2x1_100e_kinetics400_rgb'])
optimizer = dict(filepath='workdir/daotad_i3d_r50_e700_thumos14_rgb_a100/epoch_600_optim.pth')
meta = dict(filepath='workdir/daotad_i3d_r50_e700_thumos14_rgb_a100/epoch_600_meta.pth')
