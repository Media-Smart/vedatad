...
from .registry import build_from_cfg, build_from_module, registry
...
__all__ = [
    ...
    'get_logger', 'print_log', 'ProgressBar', 'build_from_cfg',
    'build_from_module', 'registry', 'check_file_exist', 'is_list_of',
    'is_str', 'is_tuple_of', 'mkdir_or_exist', 'multi_apply',
    'set_random_seed', 'slice_list', 'unmap', 'reduce_mean', 'DictAction'
]
