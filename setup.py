...
if __name__ == '__main__':
    setup(
        name='vedatad',
        version='1.0.0',
        description='Single Stage Temporal Action Detection Toolbox',
        url='https://github.com/Media-Smart/vedatad',
        author='HongxiangCai, Yichao Xiong',
        author_email='chxlll@126.com, xyc_sjtu@163.com',
        classifiers=[
